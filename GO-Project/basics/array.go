...
func main(){
	...
	b:=[3]int{1,2,3,4} //for fixed size array if we give more value it will show error .\array.go:12:18: index 3 is out of bounds (>= 3)
	f.Println(b,r.TypeOf(b))
	f.Println(b[0])//Printinng o index value
